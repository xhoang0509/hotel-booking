                ...
                <Col span={24} md={8} className="mb-24">
                    ...
                    >
                        ...
                        <Descriptions title="Thông tin cá nhân">
                            ...
                            <Descriptions.Item label="Số điện toại" span={3}>
                                {admin.phone}
                            </Descriptions.Item>
                    ...
                    {project.map((p, index) => (
                        <Col span={24} md={12} xl={6} key={index}>
                            <Card
                                ...
                                cover={<img alt="example" src={p.img.src} />}
                            >
                                ...
                                <Row gutter={[6, 0]} className="card-footer">
                                    ...
                                    <Col span={12} className="text-right">
                                        <Avatar.Group className="avatar-chips">
                                            <Avatar size="small" src={profilavatar.src} />
                                            <Avatar size="small" src={convesionImg.src} />
                                            <Avatar size="small" src={convesionImg2.src} />
                                            <Avatar size="small" src={convesionImg3.src} />
                                        </Avatar.Group>
                                    </Col>
                                </Row>
                            </Card>
