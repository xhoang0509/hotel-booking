...
function LocationCard({ location }) {
    ...
    return <div className="bg-[#F2F2F2]">
        <img src={location.thumbnail} alt="" className="w-[250px] mb-2 cursor-pointer" onClick={() => handleNameClick(location.id)} />
        <p className="text-t-primary font-bold p-2 cursor-pointer" onClick={() => handleNameClick(location.id)}>{location.name}</p>
        ...
        <div className="p-2 flex">
            <div className="p-1 bg-primary text-white mr-2 rounded-tl-lg rounded-br-lg">9.1</div>
        ...
        <div className="mx-4 my-8 text-sm mb-12">
            ...
            <p className="text-end">
                ...
                <span className="text-xl">VND 972.000 </span></p>
