...
export default function Phone({ isEdit, setIsEdit, jwt }) {
            ...
            <div className="flex flex-1 justify-between">
                <div className="w-3/4">
                    {active && (
                        <div>
                            <Typography.Text>
                                {user.phone ? user.phone : 'Bạn chưa cập nhận số điện thoại'}
                            </Typography.Text>
                            <Typography.Paragraph>
                                Chỗ nghỉ hoặc điểm tham quan bạn đặt có thể liên hệ qua số này.
                            </Typography.Paragraph>
                        </div>
                    )}
