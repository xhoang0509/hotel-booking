        ...
        <div className="py-2 px-6 flex">
            ...
            <div className="flex flex-1 justify-between">
                <div className="w-3/4">
                    {active &&
                        <div>
                            <Typography.Text>{user.birthday ? user.birthday : 'Nhập ngày sinh của bạn'}</Typography.Text>
                        </div>
                    }
                    ...
                    {!active &&
                        ...
                        >
                            <Row gutter={24} >
                                <Col span={12}>
                                    <Form.Item label="Ngày sinh" name="birthday" rules={[{ required: true, message: 'Vui lòng nhập ngày của bạn' }]}>
                                        <DatePicker onChange={onChange} defaultValue={defaultValue} format={dateFormat}/>
                                    </Form.Item>
                                </Col>
                            </Row>
                        </Form>}
